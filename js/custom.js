{
  ...
  function Naruci() {
    ...
    if (narudzbina != '') {
      ...
      narudzbina.forEach(function (element) {
        $('#narudzbina').append('<tr class="modal-pro"><td>' + element.proizvod + '</td><td>' + element.kolicina + '</td></tr>');
        // $('#narudzbina').append('<tr class="modal-pro"><td>' + element.proizvod + '</td><td><button class="btn btn-default modal-btn" onclick="Promena(' + element.id_proizvoda + ',\'minus\');">-</button>' + element.kolicina + '<button class="btn btn-default modal-btn" onclick="Promena(' + element.id_proizvoda + ',\'plus\');">+</button></td></tr>');
      })
  ...
  //       narudzbina.forEach(function (element) {
  //         $('#narudzbina').empty().append('<tr><th>proizvod</th><th>količina</th><th>cena</th></tr><tr class="modal-pro"><td>' + element.proizvod + '</td><td><button class="btn btn-default modal-btn" onclick="Promena(' + element.id_proizvoda + ',\'minus\');">-</button>' + element.kolicina + '<button class="btn btn-default modal-btn" onclick="Promena(' + element.id_proizvoda + ',\'plus\');">+</button></td></tr>');;
  //       })
  //       break;
  //     case 'minus':
  //       $("#" + id)[0].value--;
